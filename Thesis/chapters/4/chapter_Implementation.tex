...
The user is able to view which instances and nets of their design have been modified by the three buttons on the right of the \acrshort{UI} shown in Figure~\ref{fig:UI}.
